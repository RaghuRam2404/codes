...
int main(){
	...
	printOverlapping(5);
	printOverlapping(6);
	//deleteAllOverlappingFor(0);
	deleteAllOverlappingFor(1);
	deleteAllOverlappingFor(2);
	deleteAllOverlappingFor(1);
	printData();
	printBoard();
	drawRectangle(2,2,10,10,'B', '3');
	drawRectangle(8,6,10,10,'B', '3');
	printBoard();
	printBoardWithBoundary();
	printOverlapping(7);
	printOverlapping(8);
	removeAllFiguresFromAPoint(15,15);
	printData();
	printBoardWithBoundary();
}